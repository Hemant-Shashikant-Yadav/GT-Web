            ...
            <section className="mb-16">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                <p className="text-slate-700 mb-4">
                  ...
                  gestures, facial expressions, and body language. It's a
                  complete and complex language that employs signs made with the
                  hands and other movements, including facial expressions and
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-slate-700 mb-4">
                      The first school for the deaf was established in Paris by
                      Abbé Charles-Michel de l'Épée in 1760. He developed a
                      system of manual French signs that evolved into French
                      Sign Language (LSF).
                    </p>
                    <h3 className="text-xl font-semibold text-violet-800 mb-4">
                    ...
                    <p className="text-slate-700">
                      ISL emerged from a mix of French Sign Language and
                      indigenous sign languages. Thomas Hopkins Gallaudet and
                      Laurent Clerc established the first American School for
                      the Deaf in 1817.
                    </p>
                  </div>
                  <div>
...
const signLanguageTypes = [
  {
    name: "Indian Sign Language (ASL)",
    description:
      "The primary sign language used in the India. It has its own grammar and syntax distinct from English.",
  },
  {
    name: "British Sign Language (BSL)",
    description:
      "The primary sign language used in the United Kingdom. It's different from ASL and has its own unique structure.",
  },
  {
    name: "Auslan (Australian Sign Language)",
    description:
      "The sign language of the Australian deaf community, developed from British Sign Language (BSL) and Irish Sign Language.",
  },
  {
    name: "Chinese Sign Language (CSL)",
    description:
      "Used in the People's Republic of China, it's one of the most widely used sign languages in the world.",
  },
  {
    name: "International Sign",
    description:
      "A pidgin sign language used at international meetings and informally when traveling.",
  },
  {
    name: "Japanese Sign Language (JSL)",
    description:
      "The primary sign language used in Japan, developed independently from other sign languages.",
  },
];
...
const learningResources = [
  {
    name: "ASL App",
    description:
      "A mobile application that teaches ASL through interactive lessons and video tutorials.",
    url: "https://theaslapp.com",
  },
  {
    name: "SignLanguage101",
    description:
      "Free online courses covering basics to advanced concepts in various sign languages.",
    url: "https://www.signlanguage101.com",
  },
  {
    name: "Gallaudet University Resources",
    description:
      "Educational materials from the world's only university designed for deaf and hard of hearing students.",
    url: "https://www.gallaudet.edu",
  },
  {
    name: "HandSpeak",
    description:
      "Online sign language dictionary and resources for learning ASL.",
...
const benefits = [
  {
    ...
    description:
      "Learning sign language can improve spatial awareness, visual processing skills, and memory.",
  },
  {
    title: "Career Opportunities",
    description:
      "Knowledge of sign language can open up career paths in interpretation, education, and healthcare.",
  },
  {
    title: "Cultural Awareness",
    description:
      "Understanding sign language provides insight into Deaf culture and community.",
  },
  {
    title: "Better Communication",
    description:
      "Sign language skills can help communicate in noisy environments or when verbal communication isn't possible.",
  },
  {
    title: "Early Child Development",
    description:
      "Teaching babies sign language can help them communicate before they can speak.",
  },
  {
    title: "Social Inclusion",
    description:
      "Knowledge of sign language helps create a more inclusive society for the deaf and hard of hearing.",
  },
];
