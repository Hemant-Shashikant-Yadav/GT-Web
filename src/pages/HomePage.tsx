  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-violet-50">
      ...
      <motion.div 
        ...
        className="mt-20 bg-gradient-to-b from-violet-50 to-white py-16 px-4"
      >
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-violet-600 to-indigo-600 text-transparent bg-clip-text mb-8">
          ...
          <div className="text-center">
            ...
            >
              <Link 
                to="/learning-hub" 
                className="inline-block bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 min-h-[44px]"
              >
                Get Started
              </Link>
            </motion.div>
...
function FeatureCard({ 
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl md:text-2xl font-semibold mb-4 text-violet-900">{title}</h2>
